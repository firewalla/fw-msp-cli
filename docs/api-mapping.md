...
* JSON by Default: All resource-fetching commands output raw, structured JSON to stdout by default. No --jsonflag is required.
...
(The examples below assume a single-box environment or that the FIREWALLA_BOX_GIDenvironment variable is set).

Boxes 

https://docs.firewalla.net/data-models/box/

API: GET /v2/boxes https://docs.firewalla.net/api-reference/box/
...
https://docs.firewalla.net/data-models/device/

API: GET /v2/devices https://docs.firewalla.net/api-reference/device/#get-devices 
...
API: GET /v2/devices
Output: Show all devices, and all information
...
Output: Show all devices, and only main information
...
Output: Show all info for devices online
...
Output: Show all info for devices offline
...
Example Command: fw devices list --params '{"query": "network.name:IoT"}'
...
Example Command: fw devices list --params '{"query": "group.name:Kids"}'
...
Input: fw devices list --params '{"name": "[NAME]"}'
API: GET /v2/devices?name=[NAME]

Example Command: fw devices list --params '{"name": "laptop"}'
API: GET /v2/devices?name=laptop
Output: Search for devices by their customized name

Rules

https://docs.firewalla.net/data-models/rule/ 

API: GET /v2/rules https://docs.firewalla.net/api-reference/rule/#get-rules 
...
Input: fw rules list --params '{"status": "paused"}' --json
...
Example Command: fw rules list --params '{"action": "block"}'
...
Example Command: fw rules list --params '{"query": "scope.value:AA:BB:CC:DD:EE:FF"}'
...
https://docs.firewalla.net/data-models/flow/ 

API: GET /v2/flows https://docs.firewalla.net/api-reference/flow/#get-flows 
...
Output: Display a ranked list of the top 10 devices consuming the most bandwidth over the queried time period
...
Example Command: fw flows list --params '{"query": "destination.name:example.com"}'
...
Example Command: fw flows list --params '{"query": "category:gaming"}'
...
https://docs.firewalla.net/data-models/alarm/

API: GET /v2/alarms https://docs.firewalla.net/api-reference/alarm/

Input: fw alarms list --params '{"limit": 25}'
API: GET /v2/alarms?limit=25
Output: Display a chronological list of the 25 recent alarms triggered on the box.
...
Example Command: fw alarms list --params '{"query": "device.id:AA:BB:CC:DD:EE:FF"}'
...
Example Command: fw alarms update --id alm_1a2b --json '{"status": "archived"}'
